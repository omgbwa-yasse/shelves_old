...
public function createCustomerAddress() {
    $sql = "INSERT INTO customer_address (customer_id, 
        customer_address_phone1, customer_address_phone2, 
        customer_address_email1, customer_address_email2, customer_address_location)
    VALUES (?, ?, ?, ?, ?, ?)";
