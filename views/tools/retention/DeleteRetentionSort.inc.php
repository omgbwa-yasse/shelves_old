...
echo "<table border='0'>";
echo "<tr>";
echo "<td><b>Code de conservation :</b> " . $retention_sort->getretention_sortcode();
echo "<tr>";
echo "<td><b>Titre Trie de conservation parent :</b> " . $retention_sort->getretention_sortSort();
echo "<tr>";
