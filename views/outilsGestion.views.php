...
echo '<ul>
        ...
        <li><a href="/'.'../shelves/'.'index?q=outilsGestion&categ=communicability"/> Communicabilité </a></li>
        <li><a href="/'.'../shelves/'.'index?q=outilsGestion&categ=accessClassification"/> Classification accès </a></li>
