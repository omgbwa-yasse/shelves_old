...
<p>Plan de classement</p>
        <ul>
                <li><a href="home.php?q=outilsGestion&categ=planClassement&sub=allClass"> Plan de classement </a></li>
                <li><a href="home.php?q=outilsGestion&categ=planClassement&sub=addClasse"> Ajouter une classe </a></li>
        </ul>
<p>Reférentiel de conservation</p> 
        <ul>       
                <li><a href="home.php?q=outilsGestion&categ=retention&sub=allDua"> Référentiel de conservation</a></li>     
                <li><a href="home.php?q=outilsGestion&categ=retention&sub=addDuaRule"> Ajouter une règles </a></li>
        </ul>
<p>Règles de communicabilité</p>
        <ul>    
                <li><a href="home.php?q=outilsGestion&categ=communicability&sub=allCommunicability"> Règle communicabilité </a></li>
                <li><a href="home.php?q=outilsGestion&categ=communicability&sub=addCommunicabilityRule"> Ajouter une règle </a></li>
        </ul>
<p>Classe d'accès</p>  
        <ul>      
                <li><a href="home.php?q=outilsGestion&categ=accessClassification&sub=allAccess"> Classification pour l'accès </a></li>      
                <li><a href="home.php?q=outilsGestion&categ=accessClassification&sub=addAccessRule"> Ajouter une règle d'accès </a></li>
        </ul>
<p>Organigramme</p>
        <ul> 
                <li><a href="home.php?q=outilsGestion&categ=organization&sub=allOrganization"> Organigramme </a></li>
                <li><a href="home.php?q=outilsGestion&categ=organization&sub=addOrganization"> Ajouter un service </a></li>
        </ul> 
<p>Thésaurus</p>
        <ul> 
                <li><a href="home.php?q=outilsGestion&categ=thesaurus&sub=allhome"> Voir le thésaurus </a></li>
                <li><a href="home.php?q=outilsGestion&categ=thesaurus&sub=addIndex"> Ajouter une index </a></li>
        </ul>
