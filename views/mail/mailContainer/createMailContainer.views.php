...
?>
<h1>Créer un Mail Container </h1>

<form  method="POST" action="index.php?q=mail&categ=mailContainer&sub=createMailContainer">
<table>
  <tr>
    <td><label for="mail_container_reference">Référence du Mail Container :</label></td>
    <td><input type="text" id="mail_container_reference" name="mail_container_reference"></td>
  </tr>
  <tr>
    <td><label for="mail_container_title">Titre du Mail Container :</label></td>
    <td><input type="text" id="mail_container_title" name="mail_container_title"></td>
  </tr>
  <tr>
    <td><label for="mail_container_type_id">Type ID du Mail Container :</label></td>
